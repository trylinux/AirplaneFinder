# Research brief — the Great Lakes preserved-aircraft sweep (airplane.museum database)

You are researching preserved/displayed aircraft in Illinois, Indiana and Michigan for a public database
that answers "where can I go and see this airframe". Today is September 2026.
Illinois and Indiana are GREENFIELD. Michigan already holds `Air Zoo` (Portage, 1 row recorded, ~55 real) which must be TOPPED UP under that EXACT name, never re-created.
