# Research brief — the Carolinas preserved-aircraft sweep (airplane.museum database)

You are researching preserved/displayed aircraft in North Carolina and South Carolina for a public database
that answers "where can I go and see this airframe". Today is September 2026.
Both states are GREENFIELD - zero records exist.
