# Research brief — the Mid-South preserved-aircraft sweep (airplane.museum database)

You are researching preserved/displayed aircraft in Tennessee, Kentucky, Mississippi and Louisiana for a public database
that answers "where can I go and see this airframe". Today is September 2026.
Tennessee, Kentucky and Mississippi are GREENFIELD. Louisiana already holds `Barksdale Global Power Museum` (Bossier City, 1 row recorded, ~25 real) which must be TOPPED UP under that EXACT name, never re-created.
