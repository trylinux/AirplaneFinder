# Research brief — the Upper Midwest preserved-aircraft sweep (airplane.museum database)

You are researching preserved/displayed aircraft in Minnesota, Iowa, North Dakota and South Dakota for a public database
that answers "where can I go and see this airframe". Today is September 2026.
All four states are GREENFIELD - zero records exist.
