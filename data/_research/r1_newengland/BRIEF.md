# Research brief — New England preserved-aircraft sweep (airplane.museum database)

You are researching preserved/displayed aircraft in Connecticut, Rhode Island, Massachusetts, New Hampshire, Vermont and Maine for a public database
that answers "where can I go and see this airframe". Today is September 2026.
All six states are GREENFIELD - zero records exist for any of them.
