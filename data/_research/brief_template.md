# Research brief — {REGION} preserved-aircraft sweep (airplane.museum database)

You are researching preserved/displayed aircraft in {SCOPE} for a public database
