...
AIRCRAFT = [
    ...
    {"manufacturer": "Lockheed", "model": "C-130", "variant": "A", "tail_number": "57-0457", "name": None, "year_built": 1957, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Early model Hercules tactical transport."},
    {"manufacturer": "Lockheed", "model": "C-130", "variant": "E", "tail_number": "62-1787", "name": None, "year_built": 1962, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Extended range Hercules with upgraded engines."},
    {"manufacturer": "Lockheed Martin", "model": "C-130", "variant": "H", "tail_number": "74-1686", "name": None, "year_built": 1974, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Most widely produced Hercules variant."},
    {"manufacturer": "Lockheed Martin", "model": "C-130", "variant": "J", "tail_number": "99-1431", "name": "Super Hercules", "year_built": 1999, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Latest Hercules variant with glass cockpit and Rolls-Royce AE 2100D3 engines."},

    # Bombers (idx 4-9)
    {"manufacturer": "Boeing", "model": "B-17", "variant": "G", "tail_number": "44-83624", "name": "Shoo Shoo Baby", "year_built": 1944, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "WWII heavy bomber, restored to original condition."},
    {"manufacturer": "Boeing", "model": "B-29", "variant": None, "tail_number": "44-27297", "name": "Bockscar", "year_built": 1944, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Dropped the Fat Man atomic bomb on Nagasaki on August 9, 1945."},
    {"manufacturer": "Boeing", "model": "B-29", "variant": None, "tail_number": "44-86292", "name": "Enola Gay", "year_built": 1944, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Dropped the first atomic bomb on Hiroshima on August 6, 1945."},
    {"manufacturer": "Convair", "model": "B-36", "variant": "J", "tail_number": "52-2220", "name": "Peacemaker", "year_built": 1952, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Largest mass-produced piston-engined aircraft ever built."},
    {"manufacturer": "Boeing", "model": "B-52", "variant": "D", "tail_number": "56-0612", "name": "Stratofortress", "year_built": 1956, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Long-range strategic bomber used from the 1950s to present."},
    {"manufacturer": "Northrop Grumman", "model": "B-2", "variant": "A", "tail_number": "82-1066", "name": "Spirit of Kitty Hawk", "year_built": 1993, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Stealth strategic bomber with flying-wing design."},

    # Fighters (idx 10-18)
    {"manufacturer": "North American", "model": "P-51", "variant": "D", "tail_number": "44-74936", "name": "Mustang", "year_built": 1944, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Iconic WWII fighter that helped win air superiority over Europe."},
    {"manufacturer": "Lockheed", "model": "P-38", "variant": "L", "tail_number": "44-53236", "name": "Lightning", "year_built": 1944, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Distinctive twin-boom WWII fighter."},
    {"manufacturer": "Grumman", "model": "F-14", "variant": "A", "tail_number": "160694", "name": "Tomcat", "year_built": 1976, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Variable-sweep wing fleet defense fighter."},
    {"manufacturer": "McDonnell Douglas", "model": "F-15", "variant": "A", "tail_number": "76-0008", "name": "Eagle", "year_built": 1976, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Air superiority fighter with unmatched combat record."},
    {"manufacturer": "General Dynamics", "model": "F-16", "variant": "A", "tail_number": "75-0745", "name": "Fighting Falcon", "year_built": 1978, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "First production Block 1 Fighting Falcon."},
    {"manufacturer": "Lockheed Martin", "model": "F-16", "variant": "C", "tail_number": "84-1301", "name": "Fighting Falcon", "year_built": 1984, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Block 25 F-16C with improved radar."},
    {"manufacturer": "McDonnell Douglas", "model": "F/A-18", "variant": "A", "tail_number": "161749", "name": "Hornet", "year_built": 1983, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Multi-role carrier-based strike fighter."},
    {"manufacturer": "Lockheed Martin", "model": "F-22", "variant": "A", "tail_number": "91-4003", "name": "Raptor", "year_built": 2003, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Fifth-generation stealth air superiority fighter."},
    {"manufacturer": "Lockheed", "model": "F-117", "variant": "A", "tail_number": "79-10781", "name": "Nighthawk", "year_built": 1981, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "First operational stealth attack aircraft."},

    # Reconnaissance / Special (idx 19-21)
    {"manufacturer": "Lockheed", "model": "SR-71", "variant": "A", "tail_number": "61-7972", "name": "Blackbird", "year_built": 1966, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "World's fastest air-breathing manned aircraft, cruising above Mach 3."},
    {"manufacturer": "Lockheed", "model": "SR-71", "variant": "A", "tail_number": "61-7976", "name": "Blackbird", "year_built": 1966, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "SR-71 that set the transcontinental speed record."},
    {"manufacturer": "Lockheed", "model": "U-2", "variant": "C", "tail_number": "56-6680", "name": "Dragon Lady", "year_built": 1956, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "High-altitude reconnaissance aircraft."},

    # Transports / Cargo (idx 22-24)
    {"manufacturer": "Douglas", "model": "C-47", "variant": "A", "tail_number": "43-15073", "name": "Skytrain", "year_built": 1943, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Military version of DC-3, workhorse of WWII."},
    {"manufacturer": "Boeing", "model": "C-17", "variant": "A", "tail_number": "87-0025", "name": "Globemaster III", "year_built": 1993, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Strategic and tactical airlifter."},
    {"manufacturer": "Lockheed", "model": "C-5", "variant": "A", "tail_number": "69-0014", "name": "Galaxy", "year_built": 1969, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "One of the largest military transport aircraft in the world."},

    # Helicopters (idx 25-26)
    {"manufacturer": "Bell", "model": "UH-1", "variant": "H", "tail_number": "66-16579", "name": "Huey", "year_built": 1966, "aircraft_type": "rotary_wing", "wing_type": None, "military_civilian": "military", "description": "Iconic Vietnam-era helicopter."},
    {"manufacturer": "Sikorsky", "model": "UH-60", "variant": "A", "tail_number": "79-23298", "name": "Black Hawk", "year_built": 1979, "aircraft_type": "rotary_wing", "wing_type": None, "military_civilian": "military", "description": "Medium-lift utility helicopter."},

    # Early Aviation (idx 27-28)
    {"manufacturer": "Wright Brothers", "model": "Wright Flyer", "variant": None, "tail_number": None, "name": "1903 Wright Flyer", "year_built": 1903, "aircraft_type": "fixed_wing", "wing_type": "biplane", "military_civilian": "civilian", "description": "The first successful heavier-than-air powered aircraft."},
    {"manufacturer": "Curtiss", "model": "JN-4", "variant": "D", "tail_number": None, "name": "Jenny", "year_built": 1917, "aircraft_type": "fixed_wing", "wing_type": "biplane", "military_civilian": "military", "description": "Primary trainer of WWI, later a famous barnstorming aircraft."},

    # International aircraft (idx 29-34)
    {"manufacturer": "Avro", "model": "Lancaster", "variant": "B.X", "tail_number": "KB726", "name": None, "year_built": 1945, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "WWII heavy bomber used by the RAF and RCAF."},
    {"manufacturer": "Supermarine", "model": "Spitfire", "variant": "Mk.IX", "tail_number": "MK356", "name": None, "year_built": 1944, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Iconic British WWII fighter."},
    {"manufacturer": "Mitsubishi", "model": "A6M", "variant": "Zero", "tail_number": None, "name": "Zero", "year_built": 1940, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Imperial Japanese Navy fighter, dominant in the early Pacific War."},
    {"manufacturer": "Messerschmitt", "model": "Bf 109", "variant": "G", "tail_number": None, "name": None, "year_built": 1943, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "Most-produced fighter aircraft of WWII."},
    {"manufacturer": "de Havilland", "model": "Mosquito", "variant": "B.35", "tail_number": None, "name": "Wooden Wonder", "year_built": 1945, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "military", "description": "British multi-role combat aircraft built primarily of wood."},
    {"manufacturer": "Concorde", "model": "Concorde", "variant": None, "tail_number": "G-BOAA", "name": None, "year_built": 1974, "aircraft_type": "fixed_wing", "wing_type": "monoplane", "military_civilian": "civilian", "description": "Supersonic passenger airliner."},
]
